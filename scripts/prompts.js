...
var OBSERVER_PROMPT = [
  ...
  '1. START: When the statement was made (from message context) - ALWAYS include',
  '2. END: When it REFERENCES, if different - ONLY for relative time references',
  '',
  'Format: (HH:MM) [observation]. (meaning/estimated DATE)',
  '- With time reference: (14:30) User will visit parents this weekend. (meaning Feb 15-16)',
  '- Without time reference: (14:30) User prefers TypeScript with strict mode.',
  '- Do NOT add end dates for vague terms like "recently", "soon", "lately"',
  '- Split multi-event statements into separate observation lines, each with its own date',
  '',
...
var REFLECTOR_PROMPT = [
  ...
  '- Preserve and include dates/times (temporal context is critical)',
